      ...
      <section className="section">
        <div className="container license-panel">
          <div className="license-copy">
            ...
            <p className="document-note">Updated management-system and international product-certification documents will be published only after the current verified copies are available.</p>
          </div>
