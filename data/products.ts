...
export const products: Product[] = [
  ...
  },
  {
    ...
    metaDescription:
      "PV1-F flexible solar DC cable with tinned copper conductor for photovoltaic panel, string, combiner box and inverter connections.",
  ...
  },
  {
    ...
    metaDescription:
      "H1Z2Z2-K solar DC cable to EN 50618 with Class 5 tinned copper conductor for photovoltaic module, combiner box and inverter connections.",
